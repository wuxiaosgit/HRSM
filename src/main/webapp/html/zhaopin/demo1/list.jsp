  ...
  <head>
    ...
    <body>
            ...
            <span>
                <span style="float: left;">当前位置是：招聘管理-》职位发布管理</span>
                 <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="../zhaopin/SelectRoleDept.do">【添加】</a>
                </span>
            </span>
        </div>
        <div></div>
        <div class="div_search">
            <span>
                <form action="../zhaopin/selectByProps.do" method="post">
				 职位名称: 
                    ...
                    截止日期:<input type="text"  name="endTime" onclick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
