    ...
    <div style="font-size: 13px;margin: 10px 5px">
        ...
        <table border="1" width="100%" class="table_a">
            ...
            <tr>
                ...
                <td>
                	<input type="text" name="trainStarttime" value="${train.trainStarttime}" readonly="readonly"/>
                </td>
            </tr>
            <tr>
                <td>至</td>
                <td>
                	<input type="text" name="trainEndtime" value="${train.trainEndtime }" readonly="readonly"/>
               	</td>
            </tr>
            <tr>
